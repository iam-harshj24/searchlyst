...
export const PerplexityLogo = ({ className = "w-8 h-8" }) => (
    <img 
        src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69824440a17c76d392c103dc/9a4cbc0dd_image.png" 
        alt="Perplexity" 
        className={className}
    />
);
...
export const ChatGPTLogo = ({ className = "w-8 h-8" }) => (
    <img 
        src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69824440a17c76d392c103dc/6e7decc96_image.png" 
        alt="ChatGPT" 
        className={className}
    />
);
