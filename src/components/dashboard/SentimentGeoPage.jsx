    ...
    return (
        <div className="space-y-6 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {[
                    { label: 'Avg Sentiment', value: '78%', icon: Smile, change: '+6%', positive: true, gradient: 'from-emerald-500/10 to-teal-500/10', border: 'border-emerald-500/20' },
                    { label: 'Tracked Prompts', value: '142', icon: Search, change: '+23', positive: true, gradient: 'from-red-500/10 to-orange-500/10', border: 'border-red-500/20' },
                    { label: 'Active Regions', value: '38', icon: Globe, change: '+5', positive: true, gradient: 'from-blue-500/10 to-cyan-500/10', border: 'border-blue-500/20' },
                    { label: 'Negative Mentions', value: '8%', icon: Frown, change: '-3%', positive: true, gradient: 'from-amber-500/10 to-yellow-500/10', border: 'border-amber-500/20' },
                ].map((kpi, i) => {
                    const Icon = kpi.icon;
                    return (
                ...
                <div className="lg:col-span-2 bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl p-5 hover:border-red-500/20 transition-all">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-3 text-xs">
                            ...
                            <span className="flex items-center gap-1.5 text-white/40"><div className="w-2 h-2 rounded-full bg-amber-400" /> Neutral</span>
                            <span className="flex items-center gap-1.5 text-white/40"><div className="w-2 h-2 rounded-full bg-red-400" /> Negative</span>
                        </div>
                    </div>
                    <div className="h-56">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={sentimentTrend}>
                                ...
                                <Area type="monotone" dataKey="neutral" stroke="#f59e0b" strokeWidth={1.5} fill="url(#neuGrad)" />
                        ...
                        <tbody>
                            {promptPerformance.map((prompt, i) => (
                                <tr key={i} className="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors cursor-pointer">
                                        ...
                                        <div className="inline-flex items-center gap-1.5">
                                            <div className="w-16 h-1.5 bg-white/[0.06] rounded-full overflow-hidden">
                                                <div className="h-full rounded-full" style={{ 
                                                    ...
                                                    backgroundColor: prompt.sentiment > 80 ? '#22c55e' : prompt.sentiment > 60 ? '#f59e0b' : '#ef4444'
                                                }} />
                                            </div>
                                    ...
                                    <td className="text-center">
                                        <span className={`text-xs font-medium ${prompt.positive ? 'text-emerald-400' : 'text-red-400'}`}>
                                            {prompt.trend}
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <div key={i} className="flex items-center gap-4 p-3 bg-white/[0.02] rounded-xl hover:bg-white/[0.04] transition-colors cursor-pointer group">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center justify-between mb-1.5">
                                        ...
                                        <span className={`text-xs font-medium ${region.positive ? 'text-emerald-400' : 'text-red-400'}`}>{region.trend}</span>
                                    </div>
                                    ...
                                    <div className="w-full h-1 bg-white/[0.06] rounded-full mt-2 overflow-hidden">
                                        <div className="h-full rounded-full bg-gradient-to-r from-red-500 to-emerald-500" 
