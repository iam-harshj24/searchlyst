...
function generateTopicsForIndustry(user) {
    ...
    const industryTopics = {
        'Real Estate': [
            { title: `${location} Off-Plan Market ${new Date().getFullYear()}: What Investors Need to Know`, trend: 'TRENDING', trendScore: 91, reach: '2.8M', aiPotential: 'Very High', platforms: ['LinkedIn', 'Blog', 'Newsletter'], audience: 'Investors', category: 'investment', trendBadgeStyle: 'text-white border-[#333] bg-[#111]', trendDot: 'bg-[#00D26A]' },
